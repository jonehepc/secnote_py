...
- **Global scope**: `/home/jone/projects/secnotepad/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/jone/projects/secnotepad/.claude/notes/`)
...
2. Glob `/home/jone/projects/secnotepad/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/jone/projects/secnotepad/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/jone/projects/secnotepad/.claude/notes/` — works in any directory
