...
INSTALL_JS_GLOBAL="/home/jone/projects/secnotepad/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/jone/projects/secnotepad/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
