...
```
Task(
  prompt="Read /home/jone/projects/secnotepad/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/jone/projects/secnotepad/.claude/get-shit-done/templates/VALIDATION.md`
