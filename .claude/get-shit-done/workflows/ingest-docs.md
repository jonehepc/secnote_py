...
```bash
INIT=$(node "/home/jone/projects/secnotepad/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/jone/projects/secnotepad/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
