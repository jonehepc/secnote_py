...
```bash
INIT=$(node "/home/jone/projects/secnotepad/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/jone/projects/secnotepad/.claude/get-shit-done/templates/spec.md.
